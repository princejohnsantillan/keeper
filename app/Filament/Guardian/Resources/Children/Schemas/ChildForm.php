...
final class ChildForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ChildForm::getFirstNameField(),
                ChildForm::getMiddleNameField(),
                ChildForm::getLastNameField(),
                ChildForm::getNicknameField(),
                ChildForm::getBirthDateField(),
                ChildForm::getGenderField(),
